...
urlpatterns = [
    ...
    path('delete-outpass/<int:outpass_id>/', views.delete_outpass, name='delete_outpass'),
    ...
    path('api/admin/delete-outpass/<int:outpass_id>/', views.delete_outpass_api, name='delete_outpass_api'),
